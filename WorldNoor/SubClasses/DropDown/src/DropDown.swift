...
public typealias ConfigurationClosure = (Index, Any) -> Any
...
public class DropDown: UIView {
    ...
    */
    @objc public dynamic var ddCornerRadius = DPDConstant.UI.CornerRadius {
        willSet {
    ...
    */
    @objc public dynamic var ddShadowColor = DPDConstant.UI.Shadow.Color {
    ...
    Changing the shadow color automatically reloads the drop down.
    */
    @objc public dynamic var ddShadowOffset = DPDConstant.UI.Shadow.Offset {
    ...
    */
    @objc public dynamic var ddShadowOpacity = DPDConstant.UI.Shadow.Opacity {
    ...
    */
    @objc public dynamic var ddShadowRadius = DPDConstant.UI.Shadow.Radius {
    ...
    */
    ...
    public func updateDropDownCell(cell: DropDownCell, at index: Int) {
        // override me to update cell data
    }
}
...
private extension DropDown {
    ...
    func setupUI() {
        ...
        tableViewContainer.layer.shadowColor = ddShadowColor.cgColor
        tableViewContainer.layer.shadowOffset = ddShadowOffset
        tableViewContainer.layer.shadowOpacity = ddShadowOpacity
        tableViewContainer.layer.shadowRadius = ddCornerRadius
...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
    ...
    private func configureCell(_ cell: DropDownCell, at index: Int) {
        ...
        // update drop down cell with data
        updateDropDownCell(cell: cell, at: index)
