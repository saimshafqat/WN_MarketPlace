...
public class CountdownView: UIView {
  ...
  public var closeButtonTitleLabelText = ""
...
//    spinnerCircle.lineCap = CAShapeLayerLineCap.r
    spinnerCircle.lineCap = CAShapeLayerLineCap(rawValue: "round")
...
//          name: NSNotification.Name.didChangeStatusBarOrientationNotification,
//          object: nil)
      #endif
    }
