...
open class PickerDialog: UIView , UIPickerViewDelegate , UIPickerViewDataSource{
    ...
    // MARK: - Variables
    private var defaultArray = [String]()
    ...
    public init(textColor: UIColor = UIColor.black,
                ...
                font: UIFont = .boldSystemFont(ofSize: (UIScreen.main.bounds.height / 568) * 15),
    ...
    open func show(_ title: String,
                   ...
                   arrayMain: [String],
                   defaulSelectedIndex index : Int = 0,
...
//        let dialogSize = CGSize(width: 300, height: 230 )
        ...
        container.layer.shadowColor = UIColor(red: 198/255, green: 198/255, blue: 198/255, alpha: 1).cgColor
        ...
        self.picker = configuredPickerView()
        
        container.addSubview(self.picker)
    ...
    fileprivate func configuredPickerView() -> UIPickerView {
        let PickerView = UIPickerView(frame: CGRect(x: 0, y: 30, width: 0, height: 0))
        PickerView.setValue(self.textColor, forKeyPath: "textColor")
        PickerView.autoresizingMask = .flexibleRightMargin
        PickerView.frame.size.width = 300
        PickerView.frame.size.height = 216
    ...
    private func addButtonsToView(container: UIView) {
        ...
        var isLeftToRightDirection = interfaceLayoutDirection == .leftToRight
        
        let userDefaults = UserDefaults.standard
        if (userDefaults.value(forKey: "L") != nil) {
            if (userDefaults.value(forKey: "L") as! String) == "1" {
                isLeftToRightDirection = interfaceLayoutDirection == .rightToLeft
            }
        }
        ...
        self.doneButton.frame =  rightButtonFrame
        ...
        self.doneButton.titleLabel!.font = self.font.withSize(17)
        ...
        rectShape.path = UIBezierPath(roundedRect: self.doneButton.bounds, byRoundingCorners: [.bottomLeft , .bottomRight ], cornerRadii: CGSize(width: 10, height: 10)).cgPath
        
//        self.doneButton.layer.backgroundColor = kConstantsColors.kGoldenColor.cgColor
        self.doneButton.layer.backgroundColor = UIColor.themeBlueColor.cgColor
