...
open class DatePickerDialog: UIView {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.doneButton.titleLabel!.font = UIFont.boldSystemFont(ofSize: 20.0)
        ...
        rectShape.path = UIBezierPath(roundedRect: self.doneButton.bounds, byRoundingCorners: [.bottomRight ], cornerRadii: CGSize(width: 10, height: 10)).cgPath
        
        self.doneButton.layer.backgroundColor = UIColor.themeBlueColor.cgColor as! CGColor
