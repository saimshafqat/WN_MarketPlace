...
open class Popover: UIView {
  ...
  open var cornerRadiusP: CGFloat = 6.0
  ...
  open var popoverColor: UIColor = UIColor.clear
  ...
  open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
    ...
    self.contentView.layer.cornerRadius = self.cornerRadiusP
  ...
  override open func draw(_ rect: CGRect) {
    ...
    case .up:
      ...
      arrow.addLine(to: CGPoint(x: self.cornerRadiusP, y: self.bounds.height - self.arrowSize.height))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiusP,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiusP
        ),
        radius: self.cornerRadiusP,
        startAngle: self.radians(90),
        endAngle: self.radians(180),
        clockwise: true)

      arrow.addLine(to: CGPoint(x: 0, y: self.cornerRadiusP))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.cornerRadiusP,
          y: self.cornerRadiusP
        ),
        radius: self.cornerRadiusP,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusP, y: 0))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusP,
          y: self.cornerRadiusP
        ),
        radius: self.cornerRadiusP,
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.cornerRadiusP))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusP,
          y: self.bounds.height - self.arrowSize.height - self.cornerRadiusP
    ...
    case .down, .auto:
      ...
      if self.isCloseToCornerRightArrow && !self.isCornerRightArrow {
        if !isBehindCornerRightArrow {
          arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusP, y: self.arrowSize.height))
          arrow.addArc(
            withCenter: CGPoint(x: self.bounds.width - self.cornerRadiusP, y: self.arrowSize.height + self.cornerRadiusP),
            radius: self.cornerRadiusP,
            startAngle: self.radians(270.0),
            endAngle: self.radians(0),
            clockwise: true)
        } else {
          arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.arrowSize.height + self.cornerRadiusP))
        ...
        arrow.addArc(
          withCenter: CGPoint(
            x: self.bounds.width - self.cornerRadiusP,
            y: self.arrowSize.height + self.cornerRadiusP
          ),
          radius: self.cornerRadiusP,
          startAngle: self.radians(270.0),
          endAngle: self.radians(0),
      ...
      arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.cornerRadiusP))
      arrow.addArc(
        withCenter: CGPoint(
          x: self.bounds.width - self.cornerRadiusP,
          y: self.bounds.height - self.cornerRadiusP
        ),
        radius: self.cornerRadiusP,
        startAngle: self.radians(0),
        endAngle: self.radians(90),
      ...
      arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.cornerRadiusP))
    ...
    case .left:
        ...
        arrow.addLine(to: CGPoint(x:self.bounds.width - self.arrowSize.height, y: self.bounds.height - self.cornerRadiusP))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width - self.arrowSize.height - self.cornerRadiusP,
                y: self.bounds.height - self.cornerRadiusP
            ),
            radius: self.cornerRadiusP,
        ...
        arrow.addLine(to: CGPoint(x: self.cornerRadiusP, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.cornerRadiusP,
                y: self.bounds.height - self.cornerRadiusP
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiusP, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiusP,
                                y: self.cornerRadiusP
            ),
            radius: self.cornerRadiusP,
            startAngle: self.radians(270),
    ...
    case .right:
        ...
        arrow.addArc(
            withCenter: CGPoint(
                x: arrowPoint.x + self.arrowSize.height + self.cornerRadiusP,
                y: self.bounds.height - self.cornerRadiusP
            ),
            radius: self.cornerRadiusP,
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x - self.cornerRadiusP, y: self.bounds.height))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.cornerRadiusP,
                y: self.bounds.height - self.cornerRadiusP
            ),
            radius: self.cornerRadiusP,
            startAngle: self.radians(90),
        ...
        arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x, y: self.cornerRadiusP))
        arrow.addArc(
            withCenter: CGPoint(
                x: self.bounds.width + arrowPoint.x - self.cornerRadiusP,
                y: self.cornerRadiusP
        ...
        arrow.addLine(to: CGPoint(x: arrowPoint.x + self.arrowSize.height - self.cornerRadiusP, y: 0))
        arrow.addArc(
            withCenter: CGPoint(x: arrowPoint.x + self.arrowSize.height + self.cornerRadiusP,
                                y: self.cornerRadiusP
            ),
            radius: self.cornerRadiusP,
            startAngle: self.radians(-90),
    ...
    color.setFill()
    arrow.fill()
    if let borderColor = borderColorP {
...
private extension Popover {
  ...
  var isCloseToCornerLeftArrow: Bool {
    return self.arrowShowPoint.x < self.frame.origin.x + arrowSize.width/2 + cornerRadiusP
  }

  var isCloseToCornerRightArrow: Bool {
    return self.arrowShowPoint.x > (self.frame.origin.x + self.bounds.width) - arrowSize.width/2 - cornerRadiusP
  }
