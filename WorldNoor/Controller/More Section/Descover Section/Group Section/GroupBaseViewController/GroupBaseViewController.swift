...
class GroupBaseViewController: PaginatedViewController {
    
    // MARK: - Lazy Properties -
    lazy var viewModel: GroupBaseViewModel = {
    ...
    // MARK: - Methods -
    func setupViewModel() -> GroupBaseViewModel? {
        return nil
    }
...
extension GroupBaseViewController: DismissReportSheetDelegate {
...
extension GroupBaseViewController: DismissReportDetailSheetDelegate {
