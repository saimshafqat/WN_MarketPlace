...
class PageBaseViewController: PaginatedViewController {
    
    // MARK: - Lazy Properties -
    lazy var viewModel: PageBaseViewModel = {
    ...
    // MARK: - Methods -
    func setupViewModel() -> PageBaseViewModel? {
        return nil
    }
...
extension PageBaseViewController: DismissReportSheetDelegate {
...
extension PageBaseViewController: DismissReportDetailSheetDelegate {
