...
class NewTextFeedCell : UITableViewCell {
...
//    private let slp = SwiftLinkPreview(cache: InMemoryCache())
    ...
    func reloadData(){
        ...
        if self.postObj.body != nil {
            if self.postObj.linkTitle != nil {
                if self.postObj.linkTitle!.count > 0 {
                self.typeRow.append(4)
                }
            }else if self.postObj.linkImage != nil  {
...
extension NewTextFeedCell : UITableViewDelegate , UITableViewDataSource {
...
//        if self.typeRow[indexPath.row] == 4 {

//            if self.postObj.linkImage == nil && self.postObj.linkTitle == nil{
//                return 0
//            } else {
//                if self.postObj.linkImage != nil {
//                    if self.postObj.linkImage!.count > 0  {
//                        return 250
//                    }else if self.postObj.linkTitle != nil {
//                        if self.postObj.linkTitle!.count > 0  {
//                            return 100
//                        }else {
//                            return 0
...
//        }
    ...
    func textHeaderCell(tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        headerTextCell.btnShowMore.addTarget(self, action: #selector(showMoreAction), for: .touchUpInside)
...
extension NewTextFeedCell : LikeCellDelegate {
...
extension NewTextFeedCell : ReloadDelegate {
    func reloadRow(){
        self.cellDelegate.reloadRow(indexObj: indexPathMain, feedObj: self.postObj)
    }
}
