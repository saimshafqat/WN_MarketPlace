...
class NewPageImageCell : UITableViewCell {
...
extension NewPageImageCell : TLPhotosPickerViewControllerDelegate{
    func openCamera(){
...
extension NewPageImageCell:DismissReportDetailSheetDelegate   {
