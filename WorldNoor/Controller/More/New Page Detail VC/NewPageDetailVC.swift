...
protocol newPageDetailDelegate {
    func editPage(pageID: Int)
}

class NewPageDetailVC: UIViewController, UIScrollViewDelegate, UINavigationControllerDelegate {
    
    var loadSkeleton:Bool = true
    var isNavigateToDetail:Bool = false
    var currentIndex = IndexPath()
    var isCommentCamera:Bool = true
    var categoryLikePageItem: CategoryLikePageModel? = nil
    
    var groupObj: GroupValue?
    var pageCategoryType: String? = .emptyString
    ...
    fileprivate var viewModel = NewPageModel()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // editProfileVc = self.GetView(nameVC: "EditProfileTextVC", nameSB: "EditProfile") as! EditProfileTextVC
        // editProfileAboutMeVc = self.GetView(nameVC: "EditProfileAboutMEVC", nameSB: "EditProfile") as! EditProfileAboutMEVC
        // editProfileLocationVc = self.GetView(nameVC: "EditProfileLocationVC", nameSB: "EditProfile") as! EditProfileLocationVC
        // editProfileVisitedLocationVc = self.GetView(nameVC: "EditProfileVisitedLocationVC", nameSB: "EditProfile") as! EditProfileVisitedLocationVC
        // editProfileEducation = self.GetView(nameVC: "EditProfileEducationVC", nameSB: "EditProfile") as! EditProfileEducationVC
        // editProfileWork = self.GetView(nameVC: "EditProfileWorkVC", nameSB: "EditProfile") as! EditProfileWorkVC
        // editProfileOverview = self.GetView(nameVC: "EditProfileOverViewVC", nameSB: "EditProfile") as! EditProfileOverViewVC
        ManageTableView()
        manageUI()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.title = self.groupObj!.name.isEmpty ? self.groupObj?.groupName : self.groupObj?.name
        self.navigationController?.setNavigationBarHidden(false, animated: false)
        self.profileTableView.rotateViewForLanguage()
        if self.isReload {
            SharedManager.shared.isGroup = 0
        }
        viewModel.categoryLikePageItem = categoryLikePageItem
    }
    ...
    func ManageTableView()    {
        ...
        profileTableView.register(UINib.init(nibName: "NewPageaboutCell", bundle: nil), forCellReuseIdentifier: "NewPageaboutCell")
        
        
        profileTableView.register(UINib.init(nibName: "NewPageImageCell", bundle: nil), forCellReuseIdentifier: "NewPageImageCell")
        ...
        profileTableView.register(UINib.init(nibName: "PageNameVC", bundle: nil), forCellReuseIdentifier: "PageNameVC")
        profileTableView.register(ProfileUserTabCell.nib, forCellReuseIdentifier: ProfileUserTabCell.identifier)
    ...
    func callBackHandling(){
        ...
        FeedCallBManager.shared.dropDownFeedHanlder = { [weak self] (currentIndex) in
            ...
            self?.openBottomSheet(reportController, sheetSize: [.fullScreen], animated: false)
        }
        ...
        FeedCallBManager.shared.dropDownFeedCommentHanlder = { [weak self] (currentIndex) in
            ...
            self?.openBottomSheet(reportController, sheetSize: [.fixed(350)], animated: false)
        }
...
extension NewPageDetailVC:TLPhotosPickerViewControllerDelegate {
...
extension NewPageDetailVC:UIImagePickerControllerDelegate {
...
extension NewPageDetailVC:DismissReportSheetDelegate {
        ...
        RequestManager.fetchDataGet(Completion: { response in
            ...
            case .success(let res):
                ...
                if res is Int {
                    ...
                    DispatchQueue.main.async {
                        if let visibleIndexPaths = self.profileTableView.indexPathsForVisibleRows {
                            for indexPath in visibleIndexPaths {
                                if let cell = self.profileTableView.cellForRow(at: indexPath) as? PageNameVC {
    ...
    func showReportProfile(){
        ...
        ////        if !isPost {
        ////            reportDetail.commentObj = reportDetail.feedObj?.comments![0]
        ////            reportDetail.isPost = false
        ////        }
        //        self.present(self.sheetController, animated: true, completion: nil)
    }
}

extension NewPageDetailVC:DismissReportDetailSheetDelegate   {
...
extension NewPageDetailVC:GifImageSelectionDelegate  {
...
extension NewPageDetailVC:MPMediaPickerControllerDelegate  {
...
extension NewPageDetailVC: UIDocumentPickerDelegate {
...
extension NewPageDetailVC: newPageDetailDelegate, editPageDelegate {
    ...
    func editPage(pageID: Int) {
        ...
        createPageVC = self.GetView(nameVC: "PageCreateController", nameSB: "Group") as! PageCreateController
