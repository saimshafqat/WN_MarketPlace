...
//                self?.playerObserverDelegate?.didTrack(progress: time, total: CMTimeGetSeconds(currentItem.asset.duration))
            }
        } as AnyObject
    }
}
...
extension IGPlayerView1: PlayerControls {
