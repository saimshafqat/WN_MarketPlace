...
/**
 ...
 adopt the `IdentifiableSwiftMessage` protocol (as `MessageView` does) will have duplicates removed.
 */
    ...
    */
    ...
    public struct Config {
        ...
        */
        ...
        /**
         Specified whether or not duplicate `IdentifiableSwiftMessage` messages are ignored.
         The default is `true`.
        */
    ...
    /**
     ...
     views, such as `MessageView`, that adopt the `IdentifiableSwiftMessage` protocol.
...
extension SwiftMessages {
    ...
    /**
     ...
     - Parameter id: The id of a message that adopts `IdentifiableSwiftMessage`.
