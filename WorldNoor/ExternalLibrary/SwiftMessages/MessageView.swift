...
/*
 */
open class MessageView: BaseView, IdentifiableSwiftMessage, AccessibleMessage {
...
extension MessageView {
    ...
    public func configureTheme(_ theme: Theme, iconStyle: IconStyle = .default) {
        ...
        case .success:
            defaultBackgroundColor = UIColor().hexStringToUIColor(hex: "#127FA5") // logo color
        ...
        if #available(iOS 13.0, *) {
            ...
            case .info:
                backgroundColor = UIColor {
                    ...
                    case .dark, .unspecified: return UIColor().hexStringToUIColor(hex: "#127FA5")
