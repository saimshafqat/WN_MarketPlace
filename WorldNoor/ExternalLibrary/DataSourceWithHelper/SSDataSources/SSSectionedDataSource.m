...
- (NSUInteger)numberOfSections {
    return (self.currentFilter
            ...
            : (NSUInteger)[self.sections count]);
}
...
- (id)itemAtIndexPath:(NSIndexPath *)indexPath {
    return (self.currentFilter
            ...
            : [[self sectionAtIndex:indexPath.section] itemAtIndex:(NSUInteger)indexPath.row]);
}
...
//- (void) updateItems:(NSArray *)newItems atIndexPath:(NSIndexPath *)indexPath {
//    [[self sectionAtIndex:indexPath.section].items setArray:newItems];
//    [self adjustSectionAtIndex:indexPath.section toNumberOfItems:[newItems count]];
//    [self insertCellsAtIndexPaths:@[ indexPath ]];
//    [self reloadData];
//}
...
- (void)removeAllItems:(NSInteger)section {
    self.currentFilter = nil;
