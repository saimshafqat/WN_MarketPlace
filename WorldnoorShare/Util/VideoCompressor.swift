...
//                    if let cmSampleBuffer = output.copyNextSampleBuffer() {
...
//            }
        while input.isReadyForMoreMediaData {
                // Make sure there are more Audio frames to read, if not mark this as done!
                ...
                // We got a new video frame, write it to the audio input
